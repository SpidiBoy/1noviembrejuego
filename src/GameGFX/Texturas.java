 ...
 * 🔥 FIX: Separación correcta de sprites de victoria
 * 
 * @author LENOVO
 */
public class Texturas {
    ...
    private void inicializarArrays() {
        ...
        // 🔥 FIX: Inicialización correcta del array
    ...
    /**
     * 🔥 FIX COMPLETO: Carga sprites de victoria correctamente
     */
    private void cargarSpritesVictoria() {
        ...
        try {
            ...
            int x_dk_base = 1;
            int y_dk_agarra = 368;  // Justo debajo de la última fila de DK normal (292 + 40)
            int w_dk = 48;
            int h_dk = 40;
            int spacing = 2;
            
            // 🔥 FIX: Cargar 6 frames (no 3)
    ...
    public BufferedImage[] getTile1() { return tile1; }
    public BufferedImage[] getTile2() { return tile2; }
    public BufferedImage[] getTile3() { return tile3; }
    public BufferedImage[] getTile4() { return tile4; }
